...
export let options = {
  stages: [
    ...
    { duration: '1m', target: 0 }, // Encerrar gradualmente os usuários em 1 minuto
  ],
  thresholds: {
...
export function handleSummary(data) {
  return {
    "summaryApi-User.html": htmlReport(data),
  };
}

export default function () {
  let url = 'https://seazone-reservas.vercel.app/api/users';
